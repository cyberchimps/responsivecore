...
function responsive_install_plugins() {
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/core/plugins/responsive-addons.zip', // The plugin source
    ...
    $config = array(
        ...
        'default_path'      => get_stylesheet_directory() . '/core/plugins',                           // Default absolute path to pre-packaged plugins
