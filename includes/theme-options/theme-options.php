...
function responsive_theme_options_do_page() {
	...
	$options = apply_filters(
		...
		/* translators: 1: get_comments_number, 2: plugin name. */
				...
				array(
					'title'       => __( 'Select First Page for About Section', 'responsive' ),
					'subtitle'    => '',
					'heading'     => '',
					'type'        => 'select',
					'id'          => 'about_page_first',
					'description' => '',
					'placeholder' => '',
					'options'     => Responsive_Options::responsive_pro_pagelist_validate(),
				),
				array(
					'title'    => __( 'Call to Action Button Text for Second Page', 'responsive' ),
					'subtitle' => '',
					'heading'  => '',
					'type'     => 'text',
					'id'       => 'about_cta_text_first',
				),
				array(
					'title'       => __( 'Select Second Page for About Section', 'responsive' ),
					'subtitle'    => '',
					'heading'     => '',
					'type'        => 'select',
					'id'          => 'about_page_second',
					'description' => '',
					'placeholder' => '',
					'options'     => Responsive_Options::responsive_pro_pagelist_validate(),
				),
